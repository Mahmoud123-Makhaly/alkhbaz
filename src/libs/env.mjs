...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_GRANT_TYPE: z.string().min(1),
    NEXT_PUBLIC_StoreId: z.string().min(1),
    NEXT_PUBLIC_CurrencyCode: z.string().min(1),
    NEXT_PUBLIC_CatalogId: z.string().min(1),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_StoreId: process.env.NEXT_PUBLIC_StoreId,
    NEXT_PUBLIC_CurrencyCode: process.env.NEXT_PUBLIC_CurrencyCode,
    NEXT_PUBLIC_CatalogId: process.env.NEXT_PUBLIC_CatalogId,
  },
});
