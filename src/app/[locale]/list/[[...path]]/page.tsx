...
import { ProductsList, JsonLd, Loader } from '@components';
    ...
    pageSize: z
      .optional(
        z.preprocess(
          ...
          z.union([z.literal(50), z.literal(100), z.literal(150), z.literal(12)]),
        ),
      )
      .default('12'),
...
export async function generateMetadata({ params, searchParams }: Props): Promise<Metadata | null> {
